...
if ( ! class_exists( 'ACF_Module_Inspector_Admin' ) ) :
	...
	class ACF_Module_Inspector_Admin extends ACF_Admin_Tool {
		...
		function initialize() {
			...
			$this->title = __( 'ACF Module Inspector', 'acf-module-inspector' );
		...
		<p class="acf-submit">
			<input type="button" id="inspect-button" class="button button-primary" value="<?php _e( 'Inspect', 'acf-module-inspector' ); ?>" />
		</p>
    <div class="acf-module-inspector-results"></div>
			<?php
